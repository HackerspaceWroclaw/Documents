...
\section{WŁADZE}
  \begin{enumerate}
    ...
    \item Walne Zgromadzenie Członków jest najwyższą władzą Stowarzyszenia. Jego zadaniami są:
      \begin{enumerate}
        ...
        \item rozpatrywanie i zatwierdzanie sprawozdań władz Stowarzyszenia
          \begin{enumerate}
            \item W przypadku odrzucenia sprawozdania, Walne Zgromadzenie Członków przygotowuje listę poprawek, które Zarząd ma obowiązek wprowadzić
            \item Poprawione sprawozdanie Zarząd przekazuje Komisji Rewizyjnej w ciągu 7 dni, która zatwierdza jego zgodność z wytycznymi Walnego Zgromadzenia Członków
          \end{enumerate}
    ...
    \item Dla zwołania nadzwyczajnego Walnego Zgromadzenia Członków wnioskujący podaje dwa terminy. Jeśli w pierwszym terminie nie zbierze się kworum Walne Zgromadzenie Członków odbywa się w drugim terminie.
      ...
      \end{enumerate}
    \item O terminie Walnego Zgromadzenia Członków Zarząd informuje za pomocą jednej z metod:
      \begin{enumerate}
        \item Telefon
        \item E-mail
        \item List polecony
