...
\title{Statut Stowarzyszenia Hackerspace Wrocław}
...
\begin{center}
  \Huge\bf Statut Stowarzyszenia\\Hackerspace Wrocław
\end{center}
\vspace*{2cm}
  ...
  \begin{enumerate}
    ...
    \item Członkiem Zwyczajnym Stowarzyszenia może być osoba fizyczna, która spełnia stosowne postanowienia ustawy Prawo o~Stowarzyszeniach oraz~wszystkie poniższe warunki:
      \begin{enumerate}
        ...
        \item przedstawi pozytywną opinię co najmniej trojga Członków Stowarzyszenia niebędących obecnymi członkami Zarządu lub~Komisji Rewizyjnej.
      \end{enumerate}
    \item Założyciele stają się Członkami zwyczajnymi w~momencie zawiązania się Stowarzyszenia.
    \item Osoba fizyczna staje się Członkiem zwyczajnym lub~wspierającym Stowarzyszenia po~zaakceptowaniu pisemnej deklaracji członkowskiej uchwałą Zarządu Stowarzyszenia.
      \begin{enumerate}
        \item Zarząd ma prawo do~uzasadnionej odmowy przyjęcia deklaracji.
      \end{enumerate}
    \item Członkiem Honorowym Stowarzyszenia może być osoba fizyczna, która spełnia stosowne postanowienia ustawy Prawo o~Stowarzyszeniach oraz~wszystkie poniższe warunki:
      \begin{enumerate}
        ...
        \item wyrazi pisemną zgodę na~nadanie jej wyżej wymienionego tytułu,
    ...
    \item Członkowie Honorowi Stowarzyszenia nie posiadają biernego i~czynnego prawa wyborczego we władzach Stowarzyszenia.
    \item[13a.] Członkowie Wspierający Stowarzyszenia mają prawo do:
      \begin{enumerate}[label=13a.\arabic*.]
        \item korzystania z~dorobku, majątku i~wszelkich form działalności Stowarzyszenia,
        \item udziału w~zebraniach, wykładach oraz~imprezach organizowanych przez~Stowarzyszenie,
        \item zgłaszania wniosków dotyczących działalności Stowarzyszenia,
        \item brania udziału z~głosem doradczym w~statutowych władzach Stowarzyszenia.
      \end{enumerate}
    \item[13b.] Członkowie Wspierający Stowarzyszenia mają obowiązek:
      \begin{enumerate}[label=13b.\arabic*.]
        \item przestrzegania Statutu oraz~uchwał władz Stowarzyszenia;
        \item regularnego opłacania składek w~indywidualnie ustalonej kwocie.
      \end{enumerate}
    \item[13c.] Członkowie Wspierający Stowarzyszenia nie posiadają biernego i~czynnego prawa wyborczego we władzach Stowarzyszenia.
      ...
      \begin{enumerate}
        ...
        \item wykluczenia z~grona Członków przez~Zarząd z~powodu:
          \begin{enumerate}
            ...
            \item działania na~szkodę Stowarzyszenia, \label{utrata-czlonkostwa-end}
            \item śmierci Członka.
          \end{enumerate}
        \item {[uchylono]}
        \item {[uchylono]}
      \end{enumerate}
      \item Utrata członkostwa przez~Członka zwyczajnego oraz~wspierającego następuje na~podstawie uchwały Zarządu.
      \begin{enumerate}
        \item Przed~podjęciem uchwały o~wykluczeniu z~grona Członków z~powodów wskazanych w~\ref{utrata-czlonkostwa-begin}-\ref{utrata-czlonkostwa-end} Zarząd zobowiązany jest: \label{przed-usunieciem-czlonka-1}
        \begin{enumerate}
        ...
        \end{enumerate}
        \item Przed~podjęciem uchwały o~wykluczeniu z~grona Członków z~powodów wskazanych w~\ref{utrata-czlonkostwa-begin}-\ref{utrata-czlonkostwa-end} Zarząd, w~wypadku występowania sytuacji konfliktowej, powinien zorganizować w~trybie formalnym, na~wniosek dowolnej ze stron i~za~wspólną zgodą, mediacje pomiędzy stronami konfliktu \ppauza mediacja ma na~celu zażegnanie konfliktu w~sposób bezstronny oraz~polubowny. \label{przed-usunieciem-czlonka-2}
        \item Zadania, o~których mowa w~\ref{przed-usunieciem-czlonka-1} i~\ref{przed-usunieciem-czlonka-2} nie występuje w~sytuacjach nagłych, kiedy doszło do~skrajnie rażących naruszeń.
        \item Zarząd może delegować zadania opisane w~\ref{przed-usunieciem-czlonka-1} i~\ref{przed-usunieciem-czlonka-2}.
      \end{enumerate}
...
\section{WŁADZE}
  \begin{enumerate}
    ...
    \item Uchwały o~wyborze i~odwoływaniu władz Stowarzyszenia, zmianach Statutu oraz~o~rozwiązaniu Stowarzyszenia zapadają większością 2/3 uprawnionych do~głosowania, przy~obecności co najmniej 1/2 Członków zwyczajnych Stowarzyszenia.
    \item Uchwały wszystkich władz Stowarzyszenia zapadają w~trybie głosowania jawnego. Na~wniosek co najmniej jednego uczestnika zebrania, będącego Członkiem zwyczajnym, zarządza się głosowanie tajne.
      ...
      \end{enumerate}
        \item W~Walnym Zebraniu Członków biorą udział:
          \begin{enumerate}
            ...
            \item z~głosem doradczym – Członkowie honorowi, Członkowie wspierający oraz~zaproszeni goście.
          \end{enumerate}
        ...
        \item Walne Zebranie Członków w~trybie zwyczajnym jest zwoływane przez~Zarząd i~odbywa się w~siedzibie Stowarzyszenia.
...
\section{MAJĄTEK I~FUNDUSZE}
  \begin{enumerate}
    ...
    \item Zarząd zobowiązany jest dołożyć wszelkich starań w~celu utrzymania zapasu środków na~kontach Stowarzyszenia wystarczającego na~pokrycie stałych zobowiązań Stowarzyszenia przez~okres co najmniej sześciu miesięcy. \label{zapas-srodkow}
      \begin{enumerate}
        \item Nieutrzymanie wymaganego punktem \ref{zapas-srodkow} zapasu środków musi zostać bez~zbędnej zwłoki zakomunikowane Członkom Stowarzyszenia.
      \end{enumerate}
    ...
    \item Członkom Zarządu przysługuje prawo do~zwolnienia z~obowiązku opłacania składek członkowskich poczynając od~miesiąca kolejnego po~rozpoczęciu kadencji, kończąc na~miesiącu, w~którym kadencja dobiega końca.
  \end{enumerate}
