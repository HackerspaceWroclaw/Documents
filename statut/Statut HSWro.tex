...
\section{CZŁONKOWIE}
  \begin{enumerate}
    ...
    \item Członkiem Wspierającym Stowarzyszenia może być osoba fizyczna lub prawna, która spełnia stosowne postanowienia ustawy Prawo o Stowarzyszeniach oraz wszystkie poniższe warunki:
      \begin{enumerate}
        \item deklaruje pomoc finansową, rzeczową lub merytoryczną w realizacji celów Stowarzyszenia,
        \item złoży deklarację członkowską na piśmie,
        \item przedstawi pozytywną opinię co najmniej trzech członków zwyczajnych Stowarzyszenia.
      \end{enumerate}
    ...
    \item Członkowie wspierający Stowarzyszenia mają obowiązek:
      \begin{enumerate}
        \item wywiązywania się z zadeklarowanego dla Stowarzyszenia wsparcia,
        \item przestrzegania statutu i uchwał władz Stowarzyszenia.
      \end{enumerate}
