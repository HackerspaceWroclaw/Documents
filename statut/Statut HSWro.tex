  ...
  \begin{enumerate}
    ...
    \item Członkiem Zwyczajnym Stowarzyszenia może być osoba fizyczna, która spełnia stosowne postanowienia ustawy Prawo o Stowarzyszeniach oraz wszystkie poniższe warunki:
      \begin{enumerate}
        ...
        \item przedstawi pozytywną opinię co najmniej trzech członków zwyczajnych Stowarzyszenia
      \end{enumerate}
    ...
    \item[5a.] Członkiem Wspierającym Stowarzyszenia może być osoba fizyczna lub prawna, która spełnia stosowne postanowienia ustawy Prawo o Stowarzyszeniach oraz wszystkie poniższe warunki:
      \begin{enumerate}
        \item[5a.1.] deklaruje pomoc finansową, rzeczową lub merytoryczną w realizacji celów Stowarzyszenia,
        \item[5a.2.] złoży deklarację członkowską na piśmie,
        \item[5a.3.] przedstawi pozytywną opinię co najmniej trzech członków zwyczajnych Stowarzyszenia.
      \end{enumerate}
    \item[5b.] Osoba fizyczna lub prawna staje się członkiem wspierającym stowarzyszenia po zaakceptowaniu pisemnej deklaracji członkowskiej uchwałą Zarządu Stowarzyszenia.
    ...
    \item Członkowie zwyczajni Stowarzyszenia mają obowiązek:
      ...
      \end{enumerate}
    \item[10a.] Członkowie wspierający Stowarzyszenia mają prawo:
      \begin{enumerate}
        \item[10a.1.] korzystania z dorobku, majątku i wszelkich form działalności Stowarzyszenia,
        \item[10a.2.] udziału w zebraniach, wykładach oraz imprezach organizowanych przez Stowarzyszenie,
        \item[10a.3.] zgłaszania wniosków dotyczących działalności Stowarzyszenia,
        \item[10a.4.] biernego i czynnego uczestniczenia w wyborach do władz Stowarzyszenia.
      \end{enumerate}
    \item[10b.] Członkowie wspierający Stowarzyszenia mają obowiązek:
      \begin{enumerate}
        \item[10b.1.] wywiązywania się z zadeklarowanego dla Stowarzyszenia wsparcia,
        \item[10b.2.] przestrzegania statutu i uchwał władz Stowarzyszenia.
      \end{enumerate}
    ...
    \item Utrata członkostwa następuje na skutek:
      \begin{enumerate}
        ...
        \item {[uchylono]}
      \end{enumerate}
      \item Utrata członkostwa przez członka zwyczajnego i wspierającego następuje na podstawie uchwały Zarządu.
      \begin{enumerate}
        ...
        \begin{enumerate}
          ...
          \item {[uchylono]}
          \item dokonać wpisu do ewidencji członków o przeprowadzonej rozmowie dyscyplinującej oraz poinformować o tym fakcie Komisję Rewizyjną,
  ...
  \begin{enumerate}
      ...
      \end{enumerate}
        \item W Walnym Zebraniu Członków biorą udział:
          \begin{enumerate}
            ...
            \item z głosem doradczym – członkowie wspierający i honorowi oraz zaproszeni goście.
          \end{enumerate}
    ...
    \item Walne Zebranie Członków w trybie nadzwyczajnym jest zwoływane:
      \begin{enumerate}
        ...
        \item przez jedną trzecią Członków Zwyczajnych przez poinformowanie wszystkich członków stowarzyszenia zgodnie ze statutem.
        \end{enumerate}
    ...
    \item Do kompetencji Zarządu należą:
      \begin{enumerate}
        ...
        \item przyjmowanie i skreślanie członków zwyczajnych i wspierających,
        ...
        \item podejmowanie w uzasadnionych przypadkach decyzji o nieprzyjęciu deklaracji członkowskiej kandydata na członka zwyczajnego lub wspierającego.
      \end{enumerate}
...
\section{MAJĄTEK I FUNDUSZE}
  \begin{enumerate}
    ...
    \item Zarząd zobowiązany jest dołożyć wszelkich starań w celu utrzymania zapasu środków na kontach Stowarzyszenia wystarczającego na pokrycie stałych zobowiązań Stowarzyszenia przez okres co najmniej sześciu miesięcy.
